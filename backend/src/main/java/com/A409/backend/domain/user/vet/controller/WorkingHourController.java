...
//    public ApiResponse<?> getWorkingHours(@AuthenticationPrincipal Vet vet) {
...
//    public ApiResponse<?> putWorkingHours(@AuthenticationPrincipal Vet vet, @RequestBody List<WorkingHourResponse> workingHour) {
