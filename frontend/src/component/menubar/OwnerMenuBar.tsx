...
import OwnerAnimalIcon from '@/component/icon/OwnerAnimalIcon'; import OwnerMyPageIcon from '@/component/icon/OwnerMyPageIcon'; import OwnerReservationIcon from '@/component/icon/OwnerReservationIcon'; import OwnerTreatmentIcon from '@/component/icon/OwnerTreatmentIcon'; import OwnerHomeIcon from '@/component/icon/OwnerHomeIcon';
...
const menuList: Omit<Menu, 'isActive'>[] = [
  { name: '예약내역', icon: OwnerAnimalIcon, path: '/owner/home/reservation' },
  { name: '비대면 진료', icon: OwnerMyPageIcon, path: '/owner/home/treatemnet' },
