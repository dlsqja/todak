...
interface VetManagementIconProps {
  fill?: string;
  stroke?: string;
  width?: number | string;
...
const VetManagementIcon: React.FC<VetManagementIconProps> = ({
  fill = 'inherit',
  stroke = 'inherit',
  width = 24,
  height = 24,
}) => (
  <svg width={width} height={height} stroke={stroke} viewBox="0 0 24 24" fill={fill} xmlns="http://www.w3.org/2000/svg">
    <path
...
export default VetManagementIcon;
